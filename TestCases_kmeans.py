...
class TestCases(unittest.TestCase):
    ...
    def test_01_NIU(self):
        ...
        self.assertNotEqual(km.__authors__, "Yelennis Laura Rodriguez, Alvaro E. Martín Chango, Josep Molina Eirin", msg="1636581,1635979,1558589")
        self.assertNotEqual(km.__group__, "PRACT2_76", msg="PRACT2_76")
